...
<div class="space-y-8">
	<div class="flex items-center">
		...
		<div class="ml-4 space-y-1">
			...
			<p class="text-sm ">olivia.martin@email.com</p>
		</div>
	...
	<div class="flex items-center">
		...
		<div class="ml-4 space-y-1">
			...
			<p class="text-sm ">jackson.lee@email.com</p>
		</div>
	...
	<div class="flex items-center">
		...
		<div class="ml-4 space-y-1">
			...
			<p class="text-sm ">isabella.nguyen@email.com</p>
		</div>
	...
	<div class="flex items-center">
		...
		<div class="ml-4 space-y-1">
			...
			<p class="text-sm ">will@email.com</p>
		</div>
	...
	<div class="flex items-center">
		...
		<div class="ml-4 space-y-1">
			...
			<p class="text-sm ">sofia.davis@email.com</p>
		</div>
		<div class="ml-auto font-medium ">+$39.00</div>
	</div>
</div>